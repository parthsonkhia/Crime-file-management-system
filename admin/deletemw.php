...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
            ...
            <div class="area1">
            <center><u>Delete Most Wanted</u></center>
                  
                 <form action="deletemw.php" method="POST" class="form1">
                  <center>
                       <table class="table2">
                      
                        <tr>
                              <td>Select Most Wanted Criminal Name</td>
                              <td>
            	...
            	extract($_POST);
            	if (isset($btn)) {
            		$query=mysqli_query($conn,"DELETE FROM `wanted` WHERE `name`='$name'");
            		if (!empty($query)) {
            			echo "Most Wanted Criminal Deleted...<br><br>

                  <a href='deletemw.php'>Click her to refresh page</a>";
            		}
            		else	
            		{
