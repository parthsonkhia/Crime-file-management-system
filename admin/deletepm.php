...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
            ...
            <div class="area1">
            <center><u>Delete Postmortem Report</u></center>
                  
                 <form action="deletepm.php" method="POST" class="form1">
                  <center>
                       <table class="table2">
                      
                        <tr>
                              <td>Select Postmortem Victim Name</td>
                              <td>
            	...
            	extract($_POST);
            	if (isset($btn)) {
            		$query=mysqli_query($conn,"DELETE FROM `postmortem` WHERE `name`='$name'");
            		if (!empty($query)) {
            			echo "Postmortem Report Deleted...<br><br>

                  <a href='deletepm.php'>Click her to refresh page</a>";
            		}
            		else	
            		{
