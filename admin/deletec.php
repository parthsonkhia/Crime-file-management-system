...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
            ...
            <div class="area1">
            <center><u>Delete Criminal</u></center>
                  
                 <form action="deletec.php" method="POST" class="form1">
                  <center>
                       <table class="table2">
                      
                        <tr>
                              <td>Select Criminal Name</td>
                              <td>
            	...
            	extract($_POST);
            	if (isset($btn)) {
            		$query=mysqli_query($conn,"DELETE FROM `criminal` WHERE `name`='$name'");
            		if (!empty($query)) {
            			echo "Criminal Deleted...<br><br>

                  <a href='deletec.php'>Click her to refresh page</a>";
            		}
            		else	
            		{
