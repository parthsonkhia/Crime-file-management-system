...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
            ...
            <div class="area1">
            <center><u>Delete Suspect</u></center>
            	...
            	extract($_POST);
            	if (isset($btn)) {
            		$query=mysqli_query($conn,"DELETE FROM `suspect` WHERE `name`='$name'");
            		if (!empty($query)) {
            			echo "Suspect Deleted...<br><br>

                  <a href='deletes.php'>Click her to refresh page</a>";
            		}
            		else	
            		{
